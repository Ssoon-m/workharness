...
function resolveCreatePath() {
  if (process.env.WORKHARNESS_CREATE_PATH) {
    return resolve(process.env.WORKHARNESS_CREATE_PATH);
  }
  ...
  const packageJsonPath = require.resolve("workharness/package.json");
